...
@interface PersonsInfoVC () <UICollectionViewDataSource, UICollectionViewDelegate, UIWebViewDelegate>

@property (strong, nonatomic) IBOutlet UICollectionView *personsInfoCVC;
@property (strong, nonatomic) Friend *friend;
@property (strong, nonatomic) AuthWebView  *authView;
@property (strong, nonatomic) CVCell *cvCell;
...
@implementation PersonsInfoVC

- (NSArray *)initializeWebData {
    self.authView = [[AuthWebView alloc] init];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if([segue.identifier isEqualToString:@"fromCVtoTVSegue"]) {
        PersonFullInfoTV *friendInfo = segue.destinationViewController;
